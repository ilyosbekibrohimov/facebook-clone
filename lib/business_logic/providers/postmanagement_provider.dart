...
class PostProvider extends ChangeNotifier {
  ...
  Future<bool> editPost(int userId, int postId, String title, String  content,  List<int> pictureBlob) async {
    bool edited = false;
    edited = await WebService.editPost(userId, postId,  title,  content,  pictureBlob);
    notifyListeners();
